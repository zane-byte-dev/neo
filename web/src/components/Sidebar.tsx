...
import { Pin, PinOff, Trash2, MoreHorizontal, Palette, LogOut, Search, X, Pencil, Globe, BookOpen, ChevronDown, ChevronRight, LayoutGrid, Cpu, MessageSquarePlus, PanelLeftClose, Plus } from 'lucide-react'
