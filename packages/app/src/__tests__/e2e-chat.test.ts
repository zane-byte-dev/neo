...
vi.mock('@neo/agent/llm/client.js', () => {
    class MockLLMClient {
...
vi.mock('@neo/agent/utils/logger.js', () => ({
...
vi.mock('@neo/agent/services/user-service.js', () => ({
    ...
    userGetWorkspaceDir: vi.fn().mockImplementation(() => tmpDir),
    userGetStateDir: vi.fn().mockImplementation(() => tmpDir),
    userGetByTenant: vi.fn().mockReturnValue(null),
    userGetByWebToken: vi.fn().mockReturnValue(null),
}));
